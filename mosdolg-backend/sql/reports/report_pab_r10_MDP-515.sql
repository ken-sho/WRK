    ...
    with
      ...
      ACT as (select pap.participant_id,
              ...
              from md.participant_activity_profile pap
                     ...
                     left join md.class_record_status_registry crsr
                               on cr.id = crsr.class_record_id and crsr.end_date isnull
      ...
      reg_cr as (select cr.id                                                                                      as cr_id,
                        ...
                        max(case
                              when crsr.class_record_status_id in (4, 5, 8) then crsr.start_date
                              else null end)                                                                       as crsr_datee,
                        max(case
