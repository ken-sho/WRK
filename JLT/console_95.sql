...
--date_trunc('month',date1)='01.11.2022'::date;
...
where date_trunc('month',date1)='01.10.2022'::date;
...
from report.rep_810('01.11.2022','main') m;
...
from report.rep_837_byhs('01.11.2022','main') m;
...
from report.rep_810_client('01.11.2022','main') m
...
select * from report.rep_807('01.11.2022','main');
select * from report.rep_837('01.11.2022','main');
